...
# https://oss.sonatype.org/content/repositories/releases/com/norconex/collectors/norconex-collector-http/3.0.0/norconex-collector-http-3.0.0.zip


ENV COLLECTOR_USERID=2022 \
    COLLECTOR_USER=collector \
    COLLECTOR_GROUP=norconex \
    COLLECTOR_GROUPID=2022 \
    ...
    COLLECTOR_DOWNLOAD_FILENAME=norconex-collector-http-3.0.0 \
