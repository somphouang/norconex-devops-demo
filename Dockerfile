...
# .\norconex-collector-http-3.0.0-SNAPSHOT\examples\minimum
...
ENV COLLECTOR_USERID=2020 \
    COLLECTOR_USER=collector \
    COLLECTOR_GROUP=norconex \
    COLLECTOR_GROUPID=2020 \
    COLLECTOR_VERSION=3.0.0-SNAPSHOT \
    COLLECTOR_DOWNLOAD_URL=https://oss.sonatype.org/content/repositories/snapshots/com/norconex/collectors/norconex-collector-http \
    COLLECTOR_DOWNLOAD_FILENAME=norconex-collector-http-3.0.0-20201124.061504-27 \
